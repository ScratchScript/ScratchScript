...
java -jar antlr-4.13.1-complete.jar -package ScratchScript.Compiler.AST.GeneratedVisitor -Dlanguage=CSharp ../Grammar/ScratchScriptParser.g4 ../Grammar/ScratchScriptLexer.g4 -visitor -o ../../AST/GeneratedVisitor
