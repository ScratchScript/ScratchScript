...
public partial class ScratchScriptParserBaseListener : IScratchScriptParserListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterString([NotNull] ScratchScriptParser.StringContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="ScratchScriptParser.string"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitString([NotNull] ScratchScriptParser.StringContext context) { }
	/// <summary>
	/// Enter a parse tree produced by <see cref="ScratchScriptParser.stringContents"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterStringContents([NotNull] ScratchScriptParser.StringContentsContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="ScratchScriptParser.stringContents"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitStringContents([NotNull] ScratchScriptParser.StringContentsContext context) { }
