...
public interface IScratchScriptParserVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitString([NotNull] ScratchScriptParser.StringContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="ScratchScriptParser.stringContents"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitStringContents([NotNull] ScratchScriptParser.StringContentsContext context);
}
