...
public interface IBinaryHandler
{
    ...
    public ExpressionValue GetBinaryStringEquationExpression(ref Scope scope, ExpressionValue left, ExpressionValue right);
    public ExpressionValue GetBinaryNumberEquationExpression(ref Scope scope, ExpressionValue left, ExpressionValue right);
