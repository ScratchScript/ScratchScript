...
{
    public virtual T Visit(IrNode node) => node switch
    {
    ...
    public virtual T VisitBlock(IrBlockNode node) => node switch
    {
    ...
    public virtual T VisitCommand(IrCommandNode node) => node switch
    {
    ...
    public virtual T VisitExpression(IrExpressionNode node) => node switch
    {
